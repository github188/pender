...
<body class="easyui-layout">
	<div data-options="region:'north',border:false,split:true" style="padding:15px; height:84px;">
		<form id="orgQueryForm" class="search-form">
			<div class="form-item">
				<div class="text">组织名称</div>
				<div class="input">
					<input name="name" class="easyui-textbox" data-options="prompt:'组织名称'">
				</div>
			</div>
			<div class="form-item">
				<div class="text">管理关系</div>
				<div class="input">
					<select name="isRelate" class="easyui-combobox" data-options="editable:false,panelHeight:'auto'">
			...
			<div class="form-item">
				...
				<div class="input">
					<select name="mode" class="easyui-combobox" data-options="editable:false,panelHeight:'auto'">
						<option value="">全部</option>
		...
		<div class="search-btn" onclick="queryData('orgList','orgQueryForm')">查询</div>
		<div class="search-btn" onclick="resetForm('orgQueryForm')">重置</div>
		</sec:authorize>
	</div>
	...
	<script type="text/javascript">
		...
		function changeRelate(id) {
			...
			confirmMsg('确定' + (applyRelate == 1 ? '建立' : '取消') + '对该组织的管理关系吗？', function() {
				$.ajax({
