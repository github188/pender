...
<body>
	<div id="error"><table style="width:700px;">
		...
		<tr><td style="width:20px"></td><td align="left" valign="top" style="width:350px;height:120px"><!-- <a class="back_page" href="javascript:window.history.go(-1)">点击返回</a> --></td><td></td></tr>
		<tr><td colspan="2"><td style="height:20px"><strong>您无权限访问此模块</strong></td></tr>
	</table></div>	
</body>
</html>